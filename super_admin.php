<?php
    ...
    if($assistants){
        $assistants = mysqli_num_rows($assistants);
    }else{
        $assistants = 0;
    }

    $sql = "SELECT * FROM marquee";
    $messg = $conn->query($sql);
    
    if($messg){
        $messg = mysqli_num_rows($messg);
    }else{
        $messg = 0;
    }
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <li class="ms-auto"><span class="counter text-success"><?php echo $games; ?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <li class="ms-auto"><span class="counter text-purple"><?php echo $assistants; ?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <li class="ms-auto"><span class="counter text-info"><?php echo $messg; ?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
