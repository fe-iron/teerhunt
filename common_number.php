            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Common Number page</h4>
                    </div>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12" style="margin-left: auto; margin-right: auto;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                ?>
                                <form class="form-horizontal form-material" action="create_common_number.php" method="post">
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Direct</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Enter Numbers" class="form-control p-0 border-0"
                                                name="direct" required>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">House</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Enter House Numbers" class="form-control p-0 border-0"
                                                name="house" required>
                                        </div>
                                    </div>

                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Ending</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Ending..." class="form-control p-0 border-0"
                                                name="ending" required>
                                        </div>
                                    </div>
